...
from ...application.queries.get_system_health_query import GetSystemHealthQuery
from ...application.queries.get_user_activity_query import GetUserActivityQuery
...
from ...config import FileSystemSettings, GitHubSettings
...
class UnpublishPostHandler:
    ...
    def handle(self, command: UnpublishPostCommand) -> object:
...
class GetUserActivityHandler:
    ...
    def handle(self, query: GetUserActivityQuery) -> object:
...
class GetSystemHealthHandler:
    ...
    def handle(self, query: GetSystemHealthQuery) -> object:
...
@require_auth
@require_role("admin")
def unpublish_post(post_id: int) -> tuple[dict, int]:
...
@require_auth
@require_role("admin")
def get_user_activity(user_id: int) -> tuple[dict, int]:
